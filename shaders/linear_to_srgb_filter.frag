...
void main()
{
    ...
    {
        if (color[_230] <= 0.003130800090730190277099609375)
        {
            color[_230] *= 12.9200000762939453125;
        }
        else
        {
            color[_230] = 1.05499994754791259765625 * pow(color[_230], 0.4166666567325592041015625) + (-0.054999999701976776123046875);
        }
    }
