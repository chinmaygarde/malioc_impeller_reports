...
void main()
{
    ...
    highp float _934 = min(min(_1149.x, _1149.y), _1149.z);
    highp float _942 = max(max(_1149.x, _1149.y), _1149.z);
    highp vec3 _1150 = vec3(0.0);
    if (_934 < _942)
    {
        _1150 = ((_1149.xyz - vec3(_934)) * (max(max(_1139.x, _1139.y), _1139.z) - min(min(_1139.x, _1139.y), _1139.z))) / vec3(_942 - _934);
    }
    else
    {
        _1150 = vec3(0.0);
